...
public class WeaponView : MonoBehaviour
{
    ...
    public void PlayRecoil(float multiplier)
    {
        ...
        seq.Append(transform.DOLocalMove(_startLocalPos + new Vector3(0, 0, -_recoilBack * multiplier), _recoilDuration)
            .SetEase(Ease.OutQuad));
        seq.Join(transform.DOLocalRotate(_startLocalRot + new Vector3(-_recoilUp * multiplier, 0, 0), _recoilDuration)
            .SetEase(Ease.OutQuad));
